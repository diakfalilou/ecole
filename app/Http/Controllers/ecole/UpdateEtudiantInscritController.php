...
class UpdateEtudiantInscritController extends Controller
{
    //

    public function update_eleve_inscrit($slug, $id){
        // dd($slug.' '.$id);

        abort_unless(PermissionHelper::hasRoute('update.eleve'),403);
        ...
        ->first();
        // dd($eleve);
        return view('ecoles.inscription_reinscription.update_eleve_inscrit',compact('slug','parent_eleve','niveaux','eleve','id'));
    }

    public function save_update_eleve_inscrit(Request $request, $slug, $id){
