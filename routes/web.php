...
Route::post('/{slug}/edit-eleve/{id}', [EditEleveController::class, 'update_eleve'])->middleware('auth')->name('edit.eleve.update');
...
Route::post('/{slug}/update-eleve/{id}', [UpdateEtudiantInscritController::class, 'save_update_eleve_inscrit'])->middleware('auth')->name('update.eleve.save');
...
Route::post('/{slug}/update-inscription/{id}', [UpdateInfoInscriptionController::class, 'store_update'])->middleware('auth')->name('update.inscription.store');
