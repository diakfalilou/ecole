...
<div class="dashboard-main-body">
    ...
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        ...
        <div>
            <h1 class="fw-semibold mb-4 h6 text-primary-light">
                Modification de : {{ $ecole_edite->v_nomecole }}
            </h1>
    ...
    <form id="ecoleForm"
        action="{{ route('ecoles.update', ['id_ecole' => $ecole_edite->i_idecole]) }}"
        method="POST"
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select disabled
                                    ...
                                    <option value="">
                                        {{$ecole_edite->v_nometablissement}}
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    type="text"
                                    name="v_nomecole"
                                    value="{{ old('v_nomecole', $ecole_edite->v_nomecole ?? '') }}"
                           ...
                           <!-- Téléphone 1 -->
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('v_telephone1ecole', $ecole_edite->v_telephone1ecole ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('v_telephone2ecole', $ecole_edite->v_telephone2ecole ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('v_adressemailv_telephone1ecole', $ecole_edite->v_adressemailv_telephone1ecole ?? '') }}"
                            ...
                            <div class="col-md-3">
                                ...
                                <input
                                    ...
                                    value="{{ old('v_nomdirecteurecole', $ecole_edite->v_nomdirecteurecole ?? '') }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <input
                                    type="text"
                                    name="v_codeecole"
                                    value="{{ old('v_codeecole',$ecole_edite->v_codeecole) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mt-2">
                                    ...
                                    <small class="text-muted">Aperçu du logo :</small><br>

                                    <div class="logo-wrapper">

                                        <img id="logoPreview"
                                            src="{{ !empty($ecole_edite->logo_ecole) ? asset($ecole_edite->logo_ecole) : asset('assets/images/logo.png') }}"
                                            alt="Logo école">

                                        <!-- bouton X -->
                                        <span id="resetLogo" class="logo-remove">×</span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) {
        ...
        Swal.fire({
            title: 'Confirmation',
            text: "Voulez-vous vraiment la mise à jour pour cette école ?",
            icon: 'question',
...
const defaultLogo = logoPreview.src;
