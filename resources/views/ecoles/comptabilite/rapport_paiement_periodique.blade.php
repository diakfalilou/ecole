            ...
            <div class="card h-100 border-primary-100">
                <div class="card-body">
                    ...
                    <div class="h5 fw-semibold text-success-600 mb-0">
                        {{ number_format($totalEncaissement, 0, ',', ' ') }} GNF
                    </div>
                    <small class="text-secondary-light">Inscription + Scolarité</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="h5 fw-semibold text-warning-600 mb-0">
                        {{ number_format($totalExonerationGlobale, 0, ',', ' ') }} GNF
                    </div>
                    <div class="d-flex gap-8 mt-4">
                        <small class="text-secondary-light">
                            Insc : {{ number_format($totalInscriptionExo, 0, ',', ' ') }}
                        </small>
                        <small class="text-secondary-light">
                            Scol : {{ number_format($totalTrancheExo, 0, ',', ' ') }}
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <div class="h5 fw-semibold text-danger-600 mb-0">
                        {{ number_format($totalRestantGlobal, 0, ',', ' ') }} GNF
                    </div>
                    <div class="d-flex gap-8 mt-4">
                        <small class="text-secondary-light">
                            Insc : {{ number_format($totalInscriptionRestant, 0, ',', ' ') }}
                        </small>
                        <small class="text-secondary-light">
                            Scol : {{ number_format($totalTrancheRestant, 0, ',', ' ') }}
                        </small>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    @php
                        $totalDu = $totalInscriptionDu + $totalTrancheDu;
                        $taux = $totalDu > 0 ? round(($totalEncaissement / $totalDu) * 100, 1) : 0;
                        $couleurTaux = $taux >= 80 ? 'text-success-600' : ($taux >= 50 ? 'text-warning-600' : 'text-danger-600');
                    @endphp
                    <div class="h5 fw-semibold {{ $couleurTaux }} mb-8">{{ $taux }}%</div>
