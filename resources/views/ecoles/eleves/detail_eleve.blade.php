...
<div class="dashboard-main-body">
        ...
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="">
                <h1 class="fw-semibold mb-4 h6 text-primary-light">Détails de l'élève</h1>
                <div class="">
                    ...
                    <a href="{{route('index.eleves',session('slug_ecole'))}}" class="text-secondary-light hover-text-primary hover-underline"> /
                        Liste-élèves</a>
                ...
                <div class="card-body p-24">
                    <div class="d-flex gap-32 flex-md-row flex-column">
                        <div class="max-w-300-px w-100 text-center">
                            ...
                            <p class="mb-0">Admission No: <span class="text-primary-600 fw-semibold">{{$eleve->v_matricule}}</span>
                            </p>
                            <p class="mb-0">Admission No: <span class="text-primary-light fw-semibold"> {{$eleve->i_eleve_id}} </span> </p>
                        ...
                        <div class="flex-grow-1">
                            ...
                            <div class="mt-16 d-flex flex-column gap-8">
                                 <div class="d-flex gap-4">
                                    <span class="fw-semibold text-sm text-primary-light w-110-px">Classe</span>
                                    <span class="fw-normal text-sm text-secondary-light">: {{ $eleve->v_nom_classe }} </span>
                                </div>
                                <div class="d-flex gap-4">
