...
@section('containte')
    <div class="dashboard-main-body">
        <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div>
                ...
                <div>
                    ...
                    <a href="#!" class="text-secondary-light hover-text-primary hover-underline ">/ Inscription/Reinscription</a>
                    <a href="{{route('liste.inscription.reinscription',session('slug_ecole'))}}" class="text-secondary-light hover-text-primary hover-underline ">/ Liste</a>
                    <span class="text-secondary-light">
                        / Modifier les informations de l'étudiant(e) </span>
                    </div>
            </div>

            <a  href="{{route('liste.inscription.reinscription',session('slug_ecole'))}}"
        ...
        <form id="studentForm"
            method="POST"
            action="{{ route('update.eleve', [$slug, $id]) }}"
