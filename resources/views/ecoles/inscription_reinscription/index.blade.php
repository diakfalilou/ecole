...
@section('containte')
    ...
    <h1 class="fw-semibold mb-4 h6 text-primary-light">
      Liste des élèves Inscrit/Reinscit
    </h1>

    <div>
      <a href="{{route('ecole.dashboard',$slug)}}" class="text-secondary-light hover-text-primary hover-underline">
        Dashboard
      </a>
                        ...
                        <table class="table bordered-table mb-0 data-table" id="dataTable" data-page-length="10">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $eleve->v_nom_tuteur ?? 'Non défini' }}
                                    </td>


                                    <td>
                                        {{ $eleve->v_telephone_tuteur ?? 'Non défini' }}
                                    </td>
                                    <td>
                                        @php
                                            $type = strtolower(trim($eleve->v_typeinscription ?? ''));
                                        @endphp

                                        @if($type === 'inscription')
                                            <span class="badge bg-success">Inscription</span>
                                        @elseif($type === 'reinscription')
                                            <span class="badge bg-primary">Réinscription</span>
                                        @else
                                                    ...
                                                    <li>
                                                        @if($action->route_sousmenu)
                                                            <a href="{{ route($action->route_sousmenu, [$slug, $eleve->i_eleve_id]) }}"
                                                                class="dropdown-item d-flex align-items-center gap-2 py-6 open-popup">
